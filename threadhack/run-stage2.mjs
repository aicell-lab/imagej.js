...
const URL = "https://static-serve-0bc5cde8.svc.hypha.aicell.io/imagej-test/threadhack/test-stage2.html";
...
while (Date.now() < deadline) {
  ...
  if (txt.includes("=== cheerpjRunJar returned ===") || txt.includes("[sample.main] done") || /ERR:/.test(txt)) break;
